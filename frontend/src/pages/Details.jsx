  ...
  console.log(product)
    ...
    return (
      <div className="min-h-screen">
        <div className="h-1/3 w-full flex flex-col">
          {loading ? (
            ...
            <div className="flex flex-wrap justify-center items-center">
              <div className="p-4 rounded-lg w-full lg:w-1/4 md:w-1/2 md:h-1/2 m-3">
                <Slider {...settings}>
                  {product.productDetail.images.map((image, index) => (
                    <div key={index} className="flex justify-center flex-wrap">
                      <img
                        ...
                        className="w-xl h-fit object-cover rounded-lg"
                      />
                    </div>
                  ))}
                </Slider>
              </div>
              <div className="flex flex-col gap-5 h-1/3 ml-5">
                <div className="">
                  ...
                  {product?.productDetail?.stock > 0 ? <div className="text-green-500 mb-4">Stock:{product.productDetail.stock}</div> : <div className="text-red-500 mb-4">Out of stock</div>}
        ...
        <div className="h-1/3 w-full ml-1 md:ml-5">
          <div className="mt-8">
            {isAuth ? (
              <>
        ...
        <div className="h-1/3 w-[calc(50%-1rem)] md:w-full ml-1 md:ml-5">
          <div className="text-xl font-bold mb-5">Related Products</div>
